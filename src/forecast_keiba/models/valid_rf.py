...
def main(race_results_df_processed_valid, model_rf, parameters):
    return valid_rf(race_results_df_processed_valid, model_rf, parameters)

if __name__ == "__main__":
    main(race_results_df_processed_valid, model_rf, parameters)