...
def train_lr(race_results_df_processed_base):
    # 説明変数の取得
...
def main(race_results_df_processed_base):
    return train_lr(race_results_df_processed_base)

if __name__ == "__main__":
    main(race_results_df_processed_base)